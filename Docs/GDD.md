...
See [BALANCE_GUIDELINES.md](BALANCE_GUIDELINES.md) for tower stats, enemy HP scaling, DPS calculations, and score balance.
...
See [FUTURE_CONTENT.md](FUTURE_CONTENT.md) for future tower ideas, damage type system plans, and example enemies.
...
See [DESIGN_ISSUES.md](DESIGN_ISSUES.md) for active issues, resolved issues, and design gap tracking.
...
See [ECONOMY_REFERENCE.md](ECONOMY_REFERENCE.md) for tuning levers, run earnings, stack caps, synergy calculations, and progression milestones.
